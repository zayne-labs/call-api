...
CallApi is a Fetch API wrapper adds the extra features developers actually need when making HTTP requests. Due to its 1-to-1 API similarity with Fetch, it works as a drop-in replacement - if you know Fetch, you already know the basics of CallApi.
