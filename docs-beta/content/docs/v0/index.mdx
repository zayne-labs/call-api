...
Special thanks go to [ofetch by unjs](https://github.com/unjs/ofetch) for inspiring some of the features in the library, such as the function-based interceptors and retries.

Also, credit goes to the [zl-fetch fetch wrapper](https://github.com/zellwk/zl-fetch) for inspiring a few features in this library.
